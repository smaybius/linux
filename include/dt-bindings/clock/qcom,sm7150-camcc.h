...
/* CAMCC GDSCRs */
#define CAMCC_BPS_GDSC						0
#define CAMCC_IFE_0_GDSC					1
#define CAMCC_IFE_1_GDSC					2
#define CAMCC_IPE_0_GDSC					3
#define CAMCC_IPE_1_GDSC					4
#define CAMCC_TITAN_TOP_GDSC					5
