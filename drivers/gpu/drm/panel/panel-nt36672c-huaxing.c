				      ...
				      struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(connector->dev, &nt36672c_huaxing_mode);
	if (!mode)
		return -ENOMEM;
...
static int nt36672c_huaxing_probe(struct mipi_dsi_device *dsi)
{
	...
	drm_panel_init(&ctx->panel, dev, &nt36672c_huaxing_panel_funcs,
...
static const struct of_device_id nt36672c_huaxing_of_match[] = {
	{ .compatible = "mdss,nt36672c-huaxing" }, // FIXME
	{ /* sentinel */ }
};
